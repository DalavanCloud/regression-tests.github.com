...
5. Unzip that to your local computer, and work on it iteratively like we did for https://github.com/SeleniumHQ/regression-tests.github.com/demo/2915/ and https://github.com/SeleniumHQ/regression-tests.github.com/issues/2915.groovy.  You're going to need to serve up the pages on a local web-server while you work through the trial and error.
